...
Invoke-Checked 'Building LimbusHdrBalanceFix' { dotnet build (Join-Path $root 'src\LimbusHdrBalanceFix\LimbusHdrBalanceFix.csproj') -c Release -p:SkipDeploy=true }
